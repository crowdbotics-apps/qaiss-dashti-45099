"""
Django settings for qaiss_dashti_45099 project.
...
ROOT_URLCONF = 'qaiss_dashti_45099.urls'
...
WSGI_APPLICATION = 'qaiss_dashti_45099.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qaiss_dashti_45099 API",
    "DESCRIPTION": "API documentation for qaiss_dashti_45099 App",
    "VERSION": "v1",
}
